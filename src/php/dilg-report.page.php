                        ...
                        <div class="col-md-12 align-self-center">
                            <div class="tab-content" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade <?php if ($tab == "all") {
                                    ...
                                    <table class="table table1 table-hover table-striped" id="table12312312" style="width: 100%">
                                        <thead class="">
                                ...
                                <div class="tab-pane fade <?php if ($tab == "pending") {
                                    ...
                                    <table class="table table1 table-hover table-striped" id="table2" style="width: 100%">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <td class="text-center">
                                                            <div class="btn-group" role="group">
                                                                <button class="add btn hvr-pulse-grow" type="submit" name="toOngoingBtn" onclick="return confirm('Are you sure you that this report is moving to ongoing table?')"><i class="fas fa-check"></i></button>
                                                                <button class="add btn rejectBtn btn-danger hvr-pulse-grow" type="button" onclick="return confirm('Are you sure want to reject this report?')"><i class="fas fa-times"></i></button>
                                                            </div>
                                ...
                                <div class="tab-pane fade <?php if ($tab == "ongoing") {
                                    ...
                                    <table class="table table1 table-hover table-striped" id="table3" style="width: 100%">
                                        <thead class="">
                                            <tr class="text-center">
                                                <th>ID</th>
                                                <th scope="col">Reference Numbers</th>
                                ...
                                <div class="tab-pane fade <?php if ($tab == "completed") {
                                    ...
                                    <table class="table table1 table-hover table-striped" id="table4" style="width: 100%">
                                ...
                                <div class="tab-pane fade <?php if ($tab == "reject") {
                                    ...
                                    <table class="table table1 table-hover table-striped" id="table5" style="width: 100%">
                                        <thead class="">
                                            <tr class="text-center">
                                                <th>ID</th>
                                                <th scope="col">Reference Numbers</th>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    <form method="post">
                                                        ...
                                                        <td class="text-center"><?php echo $complaintDateSubmit ?></td>
                                                        <td class="text-center"><button class="add btn hvr-pulse-grow" type="submit" name="toPendingBtn" onclick="return confirm('Do you want to retrieve this report?')"><i class="fas fa-check"></i></button></td>
                                                    </form>
                                                </tr>
