        ...
        if ($password == $userPassword) {
            if ($info != $oldInfo) {
                ...
                if ($unreadstmt->execute([
                    ...
                    header("location:barangay-profile.page.php?message=password successfully updated");
                } else {
                    $message = "Not updated";
                }
            } else {
        ...
        if ($password == $userPassword) {
            if ($info != $oldInfo) {
                ...
                if ($unreadstmt->execute([
                    ...
                    header("location:barangay-profile.page.php?message=$oldInfo successfully update to $info");
                } else {
                    $message = "Not updated";
                }
            } else {
