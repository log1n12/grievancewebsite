                    ...
                    <div class="row">
                        <div class="col-md-12 align-self-center">
                            <form class="d-flex align-items-center sort">
                                ...
                                <a href="./barangay-rbi-removed.page.php" class="btn btn-dark btnSort px-4 mr-1 active">Removed</a>
                            </form>
                                    ...
                                    ?>
                                        <tr>
                                            <form method="post">
                                                ...
                                                <td><button class="add btn" type="submit" onclick="return confirm('Do you want to bring this back to RBI?')" name="toArchiveBtn"><i class="fas fa-check"></i></button></td>
                                            </form>
                                        </tr>
                                    <?php } ?>
                                </tbody>
