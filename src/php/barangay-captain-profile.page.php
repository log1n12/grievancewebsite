        ...
        if ($password == $userPassword) {
            if ($info != $oldInfo) {
                ...
                if ($unreadstmt->execute([
                    ...
                    header("location:barangay-captain-profile.page.php?message=password successfully updated");
                } else {
                    $message = "Not updated";
                }
            } else {
        ...
        if ($password == $userPassword) {
            if ($info != $oldInfo) {
                ...
                if ($unreadstmt->execute([
                    ...
                    header("location:barangay-captain-profile.page.php?message=$oldInfo successfully update to $info");
                } else {
                    $message = "Not updated";
                }
            } else {
...
elseif (isset($_POST['updateBrgyBtn2'])) {
    ...
    if ($password == $userPassword) {
        ...
        if ($unreadstmt->execute([
            ...
            header("location:barangay-captain-profile.page.php?message=name successfully updated");
        } else {
            $message = "Not updated";
        }
    } else {
...
<body>
    ...
    <div class="page-content mb-4" id="content">
        ...
        <div class="transition px-4">
                            ...
                            <table class="table mt-4 table-striped" id="myTable" style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#" type="button" data-toggle="modal" data-target="#brgyCapt">Edit</a></td>
                                    </tr>
                                    <tr>
                                        <th>Barangay Secretary</th>
                                        <td><?php echo $brgySecretary ?></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <th>Username</th>
            ...
            <div class="modal fixed-left fade" id="brgyCapt" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-aside" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" action="barangay-captain-profile.page.php">
                                <div class="container">
