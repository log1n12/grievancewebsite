                    ...
                    <div class="row">
                        <div class="col-md-12 align-self-center">
                            <form class="d-flex align-items-center sort">
                                ...
                                <a href="./barangay-report-rejected.page.php" class="btn btn-dark btnSort px-4 mr-1 active" name="all" value="all">Archive</a>
                                    ...
                                    ?>
                                        <form method="get">
                                            <tr>
                                                ...
                                                <td><button class="add btn" type="submit" name="toPendingBtn"><i class="fas fa-check"></i></button></td>
                                            </tr>
                                        </form>
                                    <?php
