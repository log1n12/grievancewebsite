<nav class="navbar navbar-expand topnav pr-5 mt-0 pt-3 pb-2 mb-4">
    ...
    <h1 class="page-title mb-0"><?php echo $titleHeader ?></h1>
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item navvitem align-self-center removeSm">
            ...
            <li class="notifff align-self-center">
                <a class="nav-link notifBell" href="barangay-notification.page.php">
            ...
            <li class="nav-item navvitem dropdown notifications-nav align-self-center" id="dropdown1234">
                <a class="nav-link" id="navbarDropdownMenuLink151" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                ...
                <div class="dropdown-menu dropdown-menu-right pt-0 overflow-auto" aria-labelledby="navbarDropdownMenuLink151" id="notificationPanel">
                    ...
                    <?php
                    $getNotif = "SELECT * FROM notification WHERE (d_to = '$barangayName' AND d_totype = 'Barangay Secretary') OR (d_to = 'all' AND d_totype='Barangay Secretary') OR (d_to = '$barangayName' AND d_totype='all') OR (d_to = 'all' AND d_totype='all') ORDER BY id DESC";
                    ...
                    foreach ($getNotifQ as $row) {
                        ...
                        if ($nFrom === "0") {
                            ...
                            foreach ($getAccountInfoQ as $row1) {
                                ...
                                } elseif ($notifPosition == "barangay_captain") {
            ...
            <li class="nav-item navvitem align-self-center">
                <a class="nav-link" href="barangay-profile.page.php"><i class="fas fa-cog" <?php
