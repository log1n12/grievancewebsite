<nav class="navbar navbar-expand-lg navbar-light padding transparent">
    <div class="container">
        <a class="brand navbar-brand" href="main.php">Grievance</a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link btnhover" href="login.page.php">Login</a>
            </div>
        </div>
    </div>
</nav>