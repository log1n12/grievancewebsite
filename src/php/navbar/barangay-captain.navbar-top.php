    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="notifff align-self-center">
                <a class="nav-link notifBell" href="barangay-captain-notification.page.php">
            ...
            <li class="nav-item navvitem dropdown notifications-nav align-self-center" id="dropdown1234">
                ...
                <div class="dropdown-menu dropdown-menu-right pt-0 overflow-auto" aria-labelledby="navbarDropdownMenuLink151">
            ...
            <li class="nav-item navvitem align-self-center">
                <a class="nav-link" href="barangay-captain-profile.page.php"><i class="fas fa-cog" <?php
