    ...
    <section id="servContent">
        <div class="container">
            <div class="sec-title text-center">
                ...
                <h3 class="text-uppercase mt-3" data-aos-offset="200" data-aos="fade-right" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-once="true">complaint form (outsider)</h3>

                <p class="mt-3 mb-2" data-aos-offset="200" data-aos="fade-right" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-once="true"> Ang complaint form na ito ay maaring magamit ng mga taong hindi residente sa Magdalena pero may gustong ireklamong residente ng Magdalena. Upang makaapila ng complaint, sagutan lang ang mga form ng tamang impormasyon at maghintay ng text na mangagaling sa inyong Barangay upang ikompirma kung natanggap o hindi ang inyong reklamo.</p>
                <a href="./service-complaint.page.php" class="mt-0 pt-0 clickHere" data-aos-offset="200" data-aos="fade-right" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-once="true">Ikaw ba ay residente ng Magdalena? Subukan ang form na ito.</a>
            </div>
            <div class="form-section mt-5" data-aos-offset="350" data-aos="fade-up" data-aos-duration="1000" data-aos-easing="ease-in-out" data-aos-once="true">
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="complaintContent cC">
                        ...
                        <div class="form-group">
                            <label for="inciAddress">Lugar ng Insidente <b>Note: </b>Maaring landmark ang ibigay.</label>
