...
if (isset($_GET['rbiid'])) {
    ...
    if ($count > 0) {
        ...
        header("location:dilg-complaint.page.php");
    }
} else {
    header("location:dilg-complaint.page.php");
}
        ...
        <div class="transition px-5">
            ...
            <section id="table-section" class="mb-4 py-4">
                <div id="tableNavbar">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="./dilg-complaint.page.php" class="text-center mx-auto d-block  mt-5">Go back to the table</a>
                ...
                <div id="tableContent" class="table-responsive px-4">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="bio-row">
                                <p><span>Barangay </span>: <?php echo $rbiBrgy . " (" . $rbiPurok . ")"; ?></p>
                            </div>
                            <div class="bio-row">
